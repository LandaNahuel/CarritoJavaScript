let productos = [
    ...
    {id:6, cat: "Vajillas", nombre:"Set Sakura", desc:"Set de vajilla para 12 personas", pres:"36 piezas", precio:180.389},
    ...
    {id:11, cat: "Remeras", nombre:"Cosecha", desc:"Remera de algodon estampada", pres:"talle S", precio:1500},
    {id:12, cat: "Remeras", nombre:"Cosecha", desc:"Remera de algodon estampada", pres:"talle M", precio:1500},
    {id:13, cat: "Remeras", nombre:"Cosecha", desc:"Remera de algodon estampada", pres:"talle L", precio:1500},
    {id:14, cat: "Remeras", nombre:"Cosecha", desc:"Remera de algodon estampada", pres:"talle XL", precio:1500},
    {id:15, cat: "Remeras", nombre:"Cosecha", desc:"Remera de algodon estampada", pres:"talle XXL", precio:1500},
...
/*
const contenedorProductos = document.getElementsByClassName("contenedor -productos")
...
stockProductos.forEach((producto) => {
    ...
    <botton id="agregar${producto.id}" class="boton-agregar">Agregar <i class="fas fa-shopping-cart"></i></botton>
    `
    contenedorProductos.appendChild(div)

    const boton = getElementById("agregar${producto.id}")
...
productos.forEach(producto => {
    ...
    div.innerHTML = `
    <h4>Codigo de producto: ${producto.cat}</h4>
    <h3>Nombre: <strong>${producto.nombre}</strong></h3>
    <p>Descripcion: ${producto.desc}</p>
    <p>Precio: ${producto.pres}</p>
    `;
